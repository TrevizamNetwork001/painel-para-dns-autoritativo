...
<div class="dashboard-card"><h3>Eventos recentes</h3><div class="event-box"><strong><?= htmlspecialchars($ultimaVerificacao) ?></strong><br><?= htmlspecialchars($mensagemCurta) ?></div><?php if ($resultadoTeste && $modalRetorno === "tools-server-" . $serverId): ?><div class="event-box" style="margin-top:10px"><strong><?= htmlspecialchars((string) ($resultadoTeste['titulo'] ?? 'Resultado')) ?></strong><br><?= htmlspecialchars($sucesso) ?></div><?php endif; ?></div>
