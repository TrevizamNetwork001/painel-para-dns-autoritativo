...
Motivação real: ao importar a zona reversa `196.162.45.in-addr.arpa`
da Conecta Network, o PTR de cada IP do bloco veio com o conteúdo
genérico do BIND (`ip-45-162-196-242.conectanetwork.net.br.`), não com
...
- 5 testes novos (`DnsZonePtrSyncTest`): caso real da Conecta
