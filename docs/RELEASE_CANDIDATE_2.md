...
O BIND legado de `ns1.conectanetwork.net.br` permaneceu sob gerenciamento
...
- `ns1.conectanetwork.net.br`: online, heartbeat em 0.7.4, UUID
...
Em `ns1.uniaonetworks.com.br`, o request
