...
Servidor: `ns1.conectanetwork.net.br` (BIND `9.20.26-1~deb13u1-Debian`,
...
|---|---|---|---|
| `conectanetwork.net.br` | 2026082701 | 1030 | 1038 |
| `196.162.45.in-addr.arpa` | 2026082701 | 257 | 258 |
...
| `c.b.2.5.4.0.8.2.ip6.arpa` | 2026082701 | 4 | 5 |
...
- **Conteúdo "—" na preview**: a view lia a chave `rdata` do payload, mas o
  formato persistido usa `content`. A zona `conectanetwork.net.br` real foi o
...
- **Truncamento silencioso do dump do BIND**: `run_command()` no agente tinha
  ...
  no meio de uma zona grande sem avisar — a mesma zona `conectanetwork.net.br`
...
`conectanetwork.net.br`) foi importada. Isso é proposital: o servidor
