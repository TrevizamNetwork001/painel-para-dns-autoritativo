...
<a class="stat stat-link" href="zones.php?status=divergencias"><div class="label">Divergências</div><div class="value"><?= (int) $zoneInventorySummary['divergencias'] ?></div><small>Ausência, serial ou coleta</small></a>
