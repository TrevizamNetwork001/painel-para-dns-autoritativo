...
<div class="stat"><div class="icon"><svg class="metric-icon" aria-hidden="true"><use href="#icon-records"></use></svg></div><div class="label">Registros DNS</div><div class="value"><?= (int) ($dnsRecordCounts['total'] ?? 0) ?></div></div>
